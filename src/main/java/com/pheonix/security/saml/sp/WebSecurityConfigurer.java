...
public class WebSecurityConfigurer extends WebSecurityConfigurerAdapter {
	...
	/* todo
	 * change later as per singpass authentication provider   
	 * load user details accordingly
	 * @return
	 */
	@Bean
	...
	/*
	 * todo
	 * change later as per singpass entrypoint to build custom redirect for request binding  
	 * 
	 */	  
	@Bean
	...
	public WebSSOProfileOptions defaultWebSSOProfileOptions() {
		...
		//webSSOProfileOptions.setBinding(org.opensaml.common.xml.SAMLConstants.SAML2_REDIRECT_BINDING_URI);
		webSSOProfileOptions.setBinding(org.opensaml.common.xml.SAMLConstants.SAML2_POST_BINDING_URI);
		// webSSOProfileOptions.setBinding(org.opensaml.common.xml.SAMLConstants.SAML2_ARTIFACT_BINDING_URI);
		//webSSOProfileOptions.setBinding(SAMLConstants.SAML2_POST_BINDING_URI);
		//webSSOProfileOptions.setBinding(SAMLConstants.SAML2_POST_BINDING_URI);
		webSSOProfileOptions.setRelayState("testing");
		webSSOProfileOptions.setAssertionConsumerIndex(1);
	...
	public ServletContextInitializer servletContextInitializer() {
		...
		return servletContext -> servletContext.getSessionCookieConfig().setName("pheonixSpSessionId");
	}
	...
	public SAMLProcessingFilter samlWebSSOProcessingFilter() throws Exception {
		...
		samlWebSSOProcessingFilter.setFilterProcessesUrl(assertionConsumerServiceURLPath);
	...
	public ExtendedMetadata extendedMetadata() {
		...
		//extendedMetadata.setTlsKey(spEntityId);
		extendedMetadata.setSigningKey(spEntityId);
		extendedMetadata.setEncryptionKey(spEntityId);
	...
	@Bean
	public TLSProtocolConfigurer tlsProtocolConfigurer() throws InvalidKeySpecException, CertificateException, NoSuchAlgorithmException, KeyStoreException, IOException, XMLStreamException {
	...
	public JKSKeyManager keyManager() throws InvalidKeySpecException, CertificateException, NoSuchAlgorithmException, KeyStoreException, IOException, XMLStreamException {
		...
		passwords.put(spEntityId, STORE_PASS);
		return new JKSKeyManager(storeFile, STORE_PASS, passwords, spEntityId);
	...
	private PrivateKey singPassPrivateKey() throws Exception {
		JKSKeyManager jksKeyManager =  keyManager();
		return (PrivateKey)
				jksKeyManager
				.getKeyStore()
				.getKey(
						spEntityId, STORE_PASS.toCharArray());
	}
